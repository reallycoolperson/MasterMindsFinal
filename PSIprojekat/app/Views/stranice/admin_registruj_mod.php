...
$.ajax({
url: "http://localhost/PSIprojekat/public/index.php/Admin/dohvati_zahtjeve",
method:"post",
dataType: "json",
...
$.ajax({
url: "http://localhost/PSIprojekat/public/index.php/Admin/delete_zahtjev",
method:"post",
data:{del_id:del_id},
error: function(ts) { alert(ts.responseText) },
success: function(data) {
...
$.ajax({
url:"http://localhost/PSIprojekat/public/index.php/Admin/insert_zahtjev",
method: "post",
data: {ins_id: ins_id},
error: function(ts) { alert(ts.responseText) },
success: function(data) {
