...
$.ajax({
async: false,
url: "http://localhost/PSIprojekat/public/index.php/Admin/ukupno_pitanja",
method: "post",
...
cnt = 0;
$.ajax({
url: "http://localhost/PSIprojekat/public/index.php/Admin/prikazi_vise_pitanja",
method:"post",
dataType: "json",
data:{ukupno:ukupno},
error: function(ts) { alert(ts.responseText) },
...
{
cnt=cnt+1;
html+= "<table style = 'background: rgba(000, 000, 000, 0.4); width: 100%;' ><tr align = 'center'>  <td colspan = '4'>  <font color = 'white' size = '3px'>  <label id = 'moderator'> <label id = 'broj'> <font size='6px'> " + cnt +". </font></label><i>" + data[i].username + "</i> (<label id = 'kategorija'><i>istorija</i></label>): </label> </u></font>  </td></tr> <tr align = 'center'>"+
...
$.ajax({
url: "http://localhost/PSIprojekat/public/index.php/Admin/obrisi_pitanje",
method:"post",
dataType: "json",
...
{
cnt1=cnt1+1;
html+= "<table style = 'background: rgba(000, 000, 000, 0.4); width: 100%;' ><tr align = 'center'>  <td colspan = '4'>  <font color = 'white' size = '3px'>  <label id = 'moderator'> <label id = 'broj'> <font size='6px'> " + cnt1 +". </font></label><i>" + data[i].username + "</i> (<label id = 'kategorija'><i>istorija</i></label>): </label> </u></font>  </td></tr> <tr align = 'center'>"+
"<td>  <label id = 'pitanje'> <font color = 'white' style = 'opacity: 2;'><i> " + data[i].tekstPitanja + "</i> </font></label>  </td>   </tr>      <tr><td> <div class='form-group has-success has-feedback'>"+
"<input type='text' class='form-control' id='tacan_odg' style ='color: green;' value= " + data[i].tacan + "  disabled>  <span class='glyphicon glyphicon-ok form-control-feedback'></span>  </div>    </td>  </tr>  <tr>    <td>      <div class='form-group has-error has-feedback'>         <input type='text' class='form-control' id='pogresan_odg1' style ='color: red; opacity: 0.4' value= " + data[i].netacan1 +  " disabled> "+
"<span class='glyphicon glyphicon-remove form-control-feedback'></span> </div>  </td> "+
"</tr>  <tr>    <td>   <div class='form-group has-error has-feedback' >   <input type='text' class='form-control' id='pogresan_odg2' style ='color: red; opacity: 0.4'  value= " + data[i].netacan2 + " disabled>  <span class='glyphicon glyphicon-remove form-control-feedback'></span>      </div>    </td>  </tr>  <tr>    <td>      <div class='form-group has-error has-feedback'>  "+
...
<i> <?php echo"{$pitanja[$i]->username}" ?> </i> (<label id = "kategorija"><i>istorija</i></label>): </label> </font>
</td>
</tr>
<tr align = "center">
<td>
