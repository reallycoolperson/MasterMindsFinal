				  ...
				  <br>
                    ...
                    <div class='row'>
                        <div class='col-sm-4' style = "color: white;">
                            ...
                            <div class="radio">	  <input type="radio" name="izbor" value="<?php echo $_SESSION['tacan1']; ?>" style="font-size:20px" style='color:white;'>  
                                <?php if(!empty($_SESSION['tacan1'])) 
                        ...
                        <div class='col-sm-8' style = "color: white;">
                            ...
                            <div class="radio">  <input type="radio" name="izbor" value="<?php echo $_SESSION['netacan1']; ?>" style="font-size:20px" style='color:white;'>  
                                <?php if(!empty($_SESSION['netacan1'])) 
                    ...
                    <div class='row'>
                        <div class='col-sm-4' style = "color: white;">
                            ...
                            <div class="radio"> <input type="radio" name="izbor" value="<?php echo $_SESSION['netacan2']; ?>" style="font-size:20px"  style='color:white;'>  
                     
                                <?php if(!empty($_SESSION['netacan2'])) 
                        ...
                        <div class='col-sm-8' style = "color: white;">
                            ...
                            <div class="radio"> <input type="radio" name="izbor" value="<?php echo $_SESSION['netacan3']; ?>" style="font-size:20px"  style='color:white;'>  
                                
                                <?php if(!empty($_SESSION['netacan3'])) 
