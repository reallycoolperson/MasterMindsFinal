    ...
    <body>
        <div class="loginBox">
            ...
            <form name="loginForma" method="get" action="<?= site_url("Home/submit")?>">
                <input type="text"  value="<?php if(!empty($_SESSION['user'])) echo $_SESSION['user']; $_SESSION['user']=""; ?>" name = "korIme" placeholder="Unesite Korisnicko ime" required>
...
<br />
                ...
                <div class = 'words_login'>
                  <i>
                    <p>Zaboravili ste lozinku?  <a href="zaboravljena_lozinka.html"> Lozinka </a> </p>
